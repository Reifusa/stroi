...
// Извлекаем информацию об авторизованном пользователе
...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-dark ec-header-light" id="body">
    ...
    <div class="d-inline-block">
        <?php echo htmlspecialchars($current_user['name'] . " " . $current_user['last_name']); ?>
        <small class="pt-1"><?php echo htmlspecialchars($current_user['email']); ?></small>
    </div>
</li>
				...
				<div class="content">
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.php">Главная</a></span><i class="mdi mdi-chevron-right"></i>
							<span><a href="user-list.php">Список пользвоателей</a></span>
    ...
    <div class="row">
		...
		<?php
// Получаем ID пользователя, чей профиль открыт
$view_user_id = intval($_GET['id']);

// Извлекаем информацию о пользователе, чей профиль просматривается
$query = "SELECT name, last_name, email, phone, address, role FROM users WHERE id = ?";
$stmt = $db->prepare($query);
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <!-- Вывод фамилии -->
                                <p><?php echo htmlspecialchars($view_user['last_name']); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <!-- Вывод номера телефона -->
                                <p><?php echo htmlspecialchars($view_user['phone']); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <!-- Вывод адреса -->
                                <p><?php echo htmlspecialchars($view_user['address']); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <!-- Вывод роли -->
                                <p><?php echo htmlspecialchars($view_user['role']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>

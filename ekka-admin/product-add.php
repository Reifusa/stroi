...
<head>
	...
	<title>АС-Админ Добавить Товар</title>
					...
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.php">Главная</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Добавить Товар
							</p>
						</div>
						<div>
							<a href="product-list.php" class="btn btn-primary"> Посмотреть все
							</a>
						</div>
					</div>
					<div class="row">
													...
													<div class="ec-vendor-main-img">
														<div class="avatar-upload">
															<div class="avatar-edit">
																<input type="file" id="imageUpload" class="ec-image-upload" accept=".png, .jpg, .jpeg" name="image" required />
															...
															<div class="avatar-preview ec-preview">
																<div class="imagePreview ec-div-preview">
																	<img class="ec-image-preview" id="imagePreview" src="assets/img/products/vender-upload-preview.jpg" alt="preview" />
																</div>
															</div>
														</div>
													</div>

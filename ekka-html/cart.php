...
if (!isset($_SESSION['user_id']) || empty($_SESSION['user_id'])) {
    ...
    exit(); // Завершаем выполнение, чтобы код ниже не исполнялся
}

// Если пользователь авторизован, продолжим выполнение страницы
print_r($_SESSION['user_id']);

// Здесь продолжение кода для отображения корзины
?>
                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Корзина</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="index.php">Главная</a></li>
                                <li class="ec-breadcrumb-item active">Корзина</li>
                            </ul>
                    ...
                    <div class="ec-cart-content">
                        <div class="ec-cart-inner">
                            ...
                            SELECT
                                ...
                                products.price,
                                cart.quantity,
                                products.quantity AS quantity_available, -- Добавляем доступное количество
                        ...
                        ";
                            ...
                            ";
                                ...
                                <form action="../cart_update.php" method="POST" id="cart-form">
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr data-prod-id="<?php echo $row['prod_id']; ?>">
                                                        <td data-label="Product" class="ec-cart-pro-name">
                                                            <a href="product-left-sidebar.php">
                                                                <img class="ec-cart-pro-img mr-4" src="../img/<?php echo htmlspecialchars($row['image']); ?>" alt="" />
                                                                <?php echo htmlspecialchars($row['name']); ?>
                                                            </a>
                                                        </td>
                                                        <td data-label="Price" class="ec-cart-pro-price">
                                                            <span class="amount" data-price="<?php echo $row['price']; ?>">
                                                                <?php echo number_format($row['price'], 2, '.', ''); ?> ₽
                                                            </span>
                                                        </td>
                                                        <td data-label="Quantity" class="ec-cart-pro-qty" style="text-align: center;">
                                                            <div>
                                                                <input class="cart-plus-minus" type="number" name="quantity[<?php echo $row['prod_id']; ?>]"
                                                                    value="<?php echo $row['quantity']; ?>" min="1"
                                                                    max="<?php echo $row['quantity_available']; ?>"
                                                        ...
                                                        <td data-label="Remove" class="ec-cart-pro-remove">
                                                            <a href="../cart_remove.php?id=<?php echo $row['prod_id']; ?>"
                    ...
                    <div class="ec-sidebar-wrap">
                        <div class="ec-sidebar-block">
                            <div class="ec-sb-title">
                                <h3 class="ec-sidebar-title">Заказ</h3>
                            </div>
                                ...
                                <div class="ec-cart-summary-bottom">
                                    <div class="ec-cart-summary">
                                        ...
                                        <div class="ec-cart-summary-total">
                                            <span class="text-left">Итоговая цена</span>
                                            <span class="text-right"><?php echo number_format($totalSum, 2, '.', ''); ?> ₽</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <form action="../order-add.php" method="POST" id="order-form">
                                ...
                                // Проверим, есть ли товары
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()): ?>
                                        <!-- Показ скрытых полей как обычные строки для отладки -->

                                        <!-- Скрытые поля для каждого товара -->
                                        <input type="hidden" name="products[<?php echo $row['prod_id']; ?>][id]" value="<?php echo $row['prod_id']; ?>">
                                        <input type="hidden" name="products[<?php echo $row['prod_id']; ?>][quantity]" value="<?php echo $row['quantity']; ?>">
                                        <input type="hidden" name="products[<?php echo $row['prod_id']; ?>][price]" value="<?php echo $row['price']; ?>">
                                    <?php endwhile; ?>
                                <?php } else { ?>
                                    <p>Корзина пуста, невозможно оформить заказ.</p>
                                <?php } ?>

                                ...
                                <div class="ec-header-user dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <?php if (isset($_SESSION['user_id'])): ?>
                                            ...
                                            <li><a class="dropdown-item" href="user-profile.php">Заказы</a></li>
                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Товар</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="index.php">Главная</a></li>
                                <li class="ec-breadcrumb-item active">Товар</li>
                            </ul>
    ...
    <section class="ec-page-content section-space-p">
        <div class="container">
            <div class="row">
                <div class="ec-pro-rightside ec-common-rightside col-lg-12 col-md-12">
                    ...
                    if ($id > 0) {
                        // Запрос с объединением таблиц products и category
                        $query = "
        SELECT 
            products.*, 
        ...
        WHERE 
            products.id = ?";
                        ...
                        echo "<p>Некорректный идентификатор товара</p>";
                        exit;
                    }
                    ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="../img/<?php echo htmlspecialchars($product['image']); ?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        <h5 class="ec-single-title"><?php echo htmlspecialchars($product['name']); ?></h5>
                                        <div class="ec-single-desc"><?php echo htmlspecialchars($product['desk']); ?></div>
                                        <div class="ec-single-price-stoke">
                                            <div class="ec-single-price">
                                                <span class="ec-single-ps-title"><?php echo htmlspecialchars($product['category_name']); ?></span>
                                                <span class="new-price"><?php echo htmlspecialchars($product['quantity']); ?> шт.</span> <!--Количество товаров на складе-->
                                                <br>
                                                <span class="new-price"><?php echo htmlspecialchars($product['price']); ?> ₽</span> <!--Цена товара-->
                                            </div>
                                        </div>
                                        <?php if (isset($_SESSION['user_id'])): ?>
                                            <form action="../cart_add.php" method="post">
                                                <div class="ec-single-qty">
                                                    <div class="qty-plus-minus">
                                                        <input class="qty-input" type="number" name="quantity" value="1" min="1" max="<?php echo $product['quantity']; ?>" />
                                                    </div>
                                        ...
                                        <?php else: ?>
                                            <div class="ec-single-cart">
                                                <a href="login.php"><button class="btn btn-primary" type="submit">Добавить в корзину</button></a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content  ec-single-pro-tab-content">
                                <div id="ec-spt-nav-review" class="tab-pane fade show active">
                                    <div class="row">
                                        ...
                                        // Проверяем, что товар с таким ID существует (можно добавить проверку на существование товара в базе)
                                        if ($product_id > 0) {
                                            // Запрос для получения отзывов для конкретного товара
                                            $reviews_query = "
        SELECT r.text, u.name, u.last_name 
        FROM reviews r
        JOIN users u ON r.id_user = u.id
        WHERE r.id_prod = $product_id
    ";
                                                    ...
                                                    <div class="ec-t-review-wrapper">
                                                        <div class="ec-t-review-item">
                                                            <div class="ec-t-review-avtar">
                                                                <!-- Здесь можно вставить изображение пользователя, если оно есть -->
                                                                <img src="assets/images/testimonial/profile.png" alt="" />
                                                            </div>
                                                            <div class="ec-t-review-content">
                                                                <div class="ec-t-review-top">
                                                                    <div class="ec-t-review-name"><?= htmlspecialchars($review['name']) ?> <?= htmlspecialchars($review['last_name']) ?></div>
                                                                </div>
                                        ...
                                        <?php
                                                ...
                                                // Если нет отзывов для данного товара
                                                echo "<p>Отзывов пока нет. Будьте первым, кто оставит отзыв!</p>";
                                            }
                                        } else {
                                                ...
                                                <?php if ($is_logged_in): ?>
                                                    <form action="../reviews-add.php" method="POST">
                                                        <div class="ec-ratting-input form-submit">
                                                            <textarea name="your-commemt" placeholder="Введите ваш комментарий"></textarea>
                                                            <button class="btn btn-primary" type="submit" value="Submit">Отправить</button>
                                                        </div>
                                                        <!-- Передаем ID товара и ID пользователя -->
                                                        <input type="hidden" name="id_prod" value="<?= $_GET['id'] ?>" />
                                                        <input type="hidden" name="id_user" value="<?= $_SESSION['user_id'] ?>" />
                                                    </form>
                                                <?php else: ?>
                                                    <p>Для добавления отзыва необходимо <a href="login.php">войти в аккаунт</a>.</p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="ec-footer-widget">
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        ...
                                        <li class="ec-footer-link"><a href="contact-us.html">Список Товаров</a></li>
                                        <li class="ec-footer-link"><a href="cart.html">Корзина</a></li>
                            ...
                            <div class="ec-footer-widget">
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        ...
                                        <li class="ec-footer-link"><a href="track-order.html">Тех. поддержка:
